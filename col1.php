...
//echo "<a style=\"text-decoration:none\" class=\"submodal\" href=\"popuptab.php?taskid=". $row["IID"] ."&project=". $project ."&PIID=".$project_id."\">";
echo "<div class=\"infobox\" style=\"".$blocker_color."\" onMouseover=\"ddrivetip('<div>".$tasktitle."</div><br><div style=padding:4px;background-color:black;position:absolute;bottom:0px;left:0px;text-align:left;font-size:12px;color:#ffffff;width:228px;overflow:hidden;>".$userlist."</div><div style=padding:4px;background-color:black;position:absolute;bottom:0px;right:0px;text-align:right;font-size:12px;color:".$color.";width:60px;>".$daycount." days</div>','#ffffff', 300)\"; onMouseout=\"hideddrivetip()\">";
